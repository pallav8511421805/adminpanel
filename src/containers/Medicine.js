...
function Medicine() {
  ...
  let schema = yup.object().shape({
    ...
    quantity: yup
      ...
      .positive()
      .integer()
      .required('Please enter your medicine quantity.'),
    price: yup
      .number()
      .positive()
      .integer()
      .required('Please enter your medicine price.'),
    expiry: yup
      .number()
      .positive()
      .integer()
      .required('Please enter your medicine expiry year.'),
    ...
    <>
      {medicine.isload ? (
        <div style={{ display: 'flex', justifyContent: 'center' }}>
          <div style={{ fontSize: 24, textAlign: 'center', color: '#1976d2' }}>
            LOADING...
          </div>
        </div>
      ) : medicine.errors != '' ? (
                ...
                <Form onSubmit={handleSubmit}>
                  <DialogContent>
                    ...
                    {errors.quantity && touched.quantity ? (
                      <p style={{ color: '#1976d2' }}>{errors.quantity}</p>
                    ) : null}
                    <TextField
                      margin="dense"
                      name="price"
                    ...
                    {errors.expiry && touched.expiry ? (
                      <p style={{ color: '#1976d2' }}>{errors.expiry}</p>
                    ) : null}
                    <>
                      <p>Profile image</p>
                      <input
